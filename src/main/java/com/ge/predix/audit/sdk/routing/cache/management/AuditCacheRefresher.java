...
@AllArgsConstructor
public class AuditCacheRefresher {
    ...
    public void refresh(ICache<String, AuditAsyncClientHolder> auditICacheToRefresh, long refreshPeriod) {
    ...
    private void refreshTokenForAuditClient(Entry<String, AuditAsyncClientHolder> entry,
                                            ICache<String, AuditAsyncClientHolder> auditICacheToRefresh,
                                            long refreshPeriod) {
            String tenantUuid = entry.getKey();
            AuditAsyncClientHolder auditAsyncClientHolder = entry.getValue();
    ...
    private boolean isAuditZoneIdExistsInTms(AuditAsyncClientHolder clientCacheObject, TmsServiceInstance<AuditServiceCredentials> instance) {
        return clientCacheObject.getAuditZoneId().equals(instance.getServiceInstanceUuid());
    }

    private AuditAsyncClientHolder refreshTokenForAuditClient(String tenantUuid, AuditAsyncClientHolder auditAsyncClientHolder, long refreshPeriod) {
    ...
    private AuditAsyncClientHolder removeCacheObject(String tenantUuid,
                                                     AuditAsyncClientHolder auditAsyncClientHolder,
                                                     ICache<String, AuditAsyncClientHolder> auditICacheToRefresh) {
